...
namespace XCode.RuningCode.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //控制面板通用js
            bundles.Add(new XCodeScriptBundle("~/JS/Admin/jucheap/BaseScripts").Include(
            ...
            bundles.Add(new XCodeScriptBundle("~/Template/Admin/jucheap/JS/Layer/BaseLayer").Include(
                "~/Template/Admin/jucheap/js/layer/layer.js"));

            bundles.Add(new XCodeScriptBundle("~/JS/Admin/jucheap/JuCheap").Include(
                "~/Template/Admin/jucheap/js/jucheap.js"));

            bundles.Add(new XCodeScriptBundle("~/JS/Admin/jucheap/JuCheapMenu").Include(
                "~/Template/Admin/jucheap/js/jucheap.menu.js"));

            

            //DataTable
            bundles.Add(new XCodeScriptBundle("~/JS/Admin/jucheap/DataTable").Include(
            ...
            //DataTable Demo Page
            bundles.Add(new XCodeScriptBundle("~/JS/Admin/jucheap/DataTableDemo").Include(
                "~/Template/Admin/jucheap/js/data-table/js/jquery.dataTables.min.js",
                "~/Template/Admin/jucheap/js/data-table/js/dataTables.tableTools.min.js",
                "~/Template/Admin/jucheap/js/data-table/js/bootstrap-dataTable.js",
                "~/Template/Admin/jucheap/js/data-table/js/dataTables.colVis.min.js",
            ...
            //tree
            bundles.Add(new XCodeScriptBundle("~/JS/Admin/jucheap/Tree").Include(
                "~/Template/Admin/jucheap/js/fuelux/js/tree.min.js"));

            //login page
            bundles.Add(new XCodeScriptBundle("~/JS/Admin/jucheap/Login").Include(
                "~/Template/Admin/jucheap/js/jquery-1.10.2.min.js",
                "~/Template/Admin/jucheap/js/bootstrap.min.js", 
                "~/Template/Admin/jucheap/js/jquery.validate.min.js",
            ...
            //nesttable js
            bundles.Add(new XCodeScriptBundle("~/JS/Admin/jucheap/Nestable").Include(
                "~/Template/Admin/jucheap/js/nestable/jquery.nestable.js"));

            //tagsinput js
            bundles.Add(new XCodeScriptBundle("~/JS/Admin/jucheap/Tags").Include(
                "~/Template/Admin/jucheap/js/tags-input.js",
                "~/Template/Admin/jucheap/js/tags-input-init.js"));

            //fileinput js
            bundles.Add(new XCodeScriptBundle("~/JS/Admin/jucheap/File").Include(
                "~/Template/Admin/jucheap/js/bootstrap-fileinput-master/js/fileinput.js",
                "~/Template/Admin/jucheap/js/file-input-init.js"));

            //email js
            bundles.Add(new XCodeScriptBundle("~/JS/Admin/jucheap/Email").Include(
            ...
            //editor js
            bundles.Add(new XCodeScriptBundle("~/JS/Admin/jucheap/Editor").Include(
                "~/Template/Admin/jucheap/js/bootstrap-wysihtml5/wysihtml5-0.3.0.js",
                "~/Template/Admin/jucheap/js/bootstrap-wysihtml5/bootstrap-wysihtml5.js",
                "~/Template/Admin/jucheap/js/summernote/dist/summernote.min.js"));

            //icheck js
            bundles.Add(new XCodeScriptBundle("~/JS/Admin/jucheap/FormValidate").Include(
                "~/Template/Admin/jucheap/js/jquery.validate.min.js",
            ...
            bundles.Add(new XCodeScriptBundle("~/JS/Front/Web/Home").Include(
